...
#myroots = GetPadeApproximantRootsFiles(3,3,"./papprox")
#myNumeratorRoots= myroots[1:numeratorOrder]## geting numerator roots
#myDenominatorRoots = myroots[numeratorOrder+1:numeratorOrder+denominatorOrder]## geting numerator roots



#myroots = GetPadeApproximantRootsFiles(2,2,"C:\\Users\\Manoj Yadav\\Desktop\\temp\\papprox")### using file
