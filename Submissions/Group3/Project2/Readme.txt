...
We use a Likelihood function, and plot individual likelihoods, and the mulitply them to obtain the combined likelihood. Whose maximum gave us h (or H0, equivalently). Using only gold sample, we obtain h=0.647.
